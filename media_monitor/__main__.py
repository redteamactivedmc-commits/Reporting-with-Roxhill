...
@click.option("--items-file", default=None, help="Path to JSON file with coverage items")
...
@click.option("--client",       required=True, help="Client name")
@click.option("--entries-file", default=None,  help="Path to JSON file with tracker entries")
