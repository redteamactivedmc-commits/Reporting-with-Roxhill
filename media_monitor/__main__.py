...
@click.option("--date",        default="",     help="Publishing date  e.g. '25th March 2026'")
...
def cmd_snapshot(url, client, magazine, headline, date, publication):
    ...
    Example:
      python -m media_monitor snapshot \\
        --url "https://www.securitymea.com/2026/03/25/..." \\
        --client "KnowBe4" \\
        --magazine "Security MEA" \\
        --headline "KnowBe4 Launches Phish Alert Button..." \\
...
def cmd_coverage_24h(client, campaign, date, items_file):
    ...
    Example:
      python -m media_monitor coverage-24h \\
        --client "KnowBe4" \\
        --campaign "Phish Alert Button for Microsoft Teams" \\
